...
@Component({
  selector: 'app-cuentas-pagar-pagadas',
  templateUrl: './cuentas-pagar-pagadas.component.html',
  styleUrls: ['./cuentas-pagar-pagadas.component.css']
})
export class CuentasPagarPagadasComponent implements OnInit {
  title:string="Cuentas Pagar Pagadas"
  Table:any = []
  selectedData:any
  ...
  constructor(
    ...
    private mainService: CuentasPagarService,
    private childService: MovimientosPagarService
  ) { }
